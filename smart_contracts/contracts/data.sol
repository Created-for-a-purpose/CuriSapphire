...
contract Data {
    ...
    function addPatientData(
        ...
        patientData memory _patientData = patientData(
            owner,
            _access,
            _name,
            _age,
    ...
    function addPharmacyData(
        ...
        healthcareProviderData memory _pharmacyData = healthcareProviderData(
            owner,
            _name,
            _license,
            _address,
    ...
    function addHospitalData(
        ...
        healthcareProviderData memory _hospitalData = healthcareProviderData(
            owner,
            _name,
            _license,
            _address,
    ...
    function proxy_giveAccess(address owner, address to) external signedOnly {
        giveAccess(owner, to);
    }
}
